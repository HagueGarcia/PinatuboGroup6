        ...
        let list_easy = ["READING", "WALKING AROUND NUDE", "WATCHING TV/MOVIE", "EATING", "TAKING A BATH", "SINGING", "SLEEPING", "DANCING"];
        let list_easy_keywords = ["READ", "WALK AROUND NUDE", "WATCHING MOVIE", "EAT", "SHOWER", "SING", "SLEEP", "DANCE"];
        let listPoints = [ 27, 26, 18, 10, 6, 4, 4, 3 ];
        var z= "";
